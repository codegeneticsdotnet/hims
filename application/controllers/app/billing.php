...
class Billing extends General{
	...
	public function getItemSearch($itemname){
		$this->data['itemname'] = $this->billing_model->itemsearch($itemname);
		$this->load->view("app/billing/itemsearch",$this->data);	
	}	
	...
	public function itemsearch($itemname){
		$res = $this->billing_model->itemsearch($itemname);
