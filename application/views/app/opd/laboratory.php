                                ...
                                <div class="nav-tabs-custom">
                                    ...
                                    <div class="tab-content">
                                    	<div class="tab-pane active" id="tab_1">
                                            ...
                                            <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> Add Laboratory Results</a>
                                            <a href="<?php echo base_url()?>app/lab_services/add_request?patient_no=<?php echo $getOPDPatient->patient_no;?>&ref=opd" class="btn btn-warning"><i class="fa fa-flask"></i> Create Lab Request</a>
