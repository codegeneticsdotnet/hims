...
function showBills(val){
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                            ...
                                                            <input type="text" name="tboxitemname" id="tboxitemname" value = "" class="form-control">

                                            </td>
                                        </tr>
                                        <tr>
                                        	<td>Paricular Item                                                             <input type="text" name="tboxitemname" id="tboxitemname" value = "" class="form-control">
</td>
                                            <td>
                                            <input type="text" name="tboxitemname" id="tboxitemname" value = "<?php echo $itemname; ?>" class="form-control">
