                                ...
                                <div class="nav-tabs-custom">
                                    ...
                                    <div class="tab-content">
                                    	<div class="tab-pane active" id="tab_1">
                                           ...
                                           <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> Create Discharge Summary</a>
                                           <?php }}?>
                                           ...
                                           <tbody>
                                           <?php foreach($discharge_summary as $rows){?>
                                           <tr>
                                           		<td><?php echo date("M d, Y h:i:s A",strtotime($rows->dDateTime));?></td>
                                                <td><?php echo $rows->reason_admission?></td>
                                                <td><?php echo $rows->condition_discharge?></td>
                                                <td><?php 
												$ci_obj = & get_instance();
                                                ...
                                                <?php if($this->session->userdata('emr_viewing') == ""){?>	
                                                <?php if($getOPDPatient->nStatus == "Pending"){?>
                                                <a href="<?php echo base_url()?>app/ipd/delete_discharge_summary/<?php echo $rows->summary_id?>/<?php echo $getOPDPatient->IO_ID?>/<?php echo $getOPDPatient->patient_no?>" onClick="return confirm('Are you sure you want to remove?');">Remove</a>
                                                <?php }}?>
                                                </td>
                                           </tr>
                                           <?php }?> 
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Discharge Summary</h4>
                                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td><textarea name="reason_admission" placeholder="Reason for Admission" class="form-control input-sm" style="width: 100%;" rows="3"></textarea></td>
                                        </tr>
                                        <tr>
                                        	<td>Condition Upon Discharge</td>
                                            <td><textarea name="condition_discharge" placeholder="Condition Upon Discharge" class="form-control input-sm" style="width: 100%;" rows="3"></textarea></td>
                                        </tr>
                                        <tr>
                                        	<td>Admitting Diagnosis</td>
                                            <td><textarea name="admitting_diagnosis" placeholder="Admitting Diagnosis" class="form-control input-sm" style="width: 100%;" rows="3"></textarea></td>
                                        </tr>
                                        <tr>
                                        	<td>Physical Examination</td>
                                            <td><textarea name="physical_exam" placeholder="Physical Examination" class="form-control input-sm" style="width: 100%;" rows="3"></textarea></td>
                                        </tr>
                                        <tr>
                                        	<td>Clinical Findings</td>
                                            <td><textarea name="clinical_findings" placeholder="Clinical Findings" class="form-control input-sm" style="width: 100%;" rows="3"></textarea></td>
                                        </tr>
                                        <tr>
                                        	<td>Course in the Ward</td>
                                            <td><textarea name="course_ward" placeholder="Course in the Ward" class="form-control input-sm" style="width: 100%;" rows="3"></textarea></td>
                                        </tr>
                                        <tr>
                                        	<td>Final Diagnosis</td>
                                            <td><textarea name="final_diagnosis" placeholder="Final Diagnosis" class="form-control input-sm" style="width: 100%;" rows="3"></textarea></td>
                                        </tr>
                                        <tr>
                                        	<td>Medication</td>
                                            <td><textarea name="medication" placeholder="Medication" class="form-control input-sm" style="width: 100%;" rows="3"></textarea></td>
                                        </tr>
                                        <tr>
                                        	<td>Follow-up</td>
                                            <td><textarea name="follow_up" placeholder="Follow-up" class="form-control input-sm" style="width: 100%;" rows="3"></textarea></td>
                                        </tr>
                                        </tbody>
                                        </table>
                                        </div>
