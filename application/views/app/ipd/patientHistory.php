<?php require_once(APPPATH.'views/include/head.php');?>
    <body class="skin-blue">
                                ...
                                <div class="nav-tabs-custom">
                                    ...
                                    <div class="tab-content">
                                    	<div class="tab-pane active" id="tab_1">
                                           ...
                                           <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> Add Patient History</a>
                                           <?php }}?>
                                           <a href="<?php echo base_url()?>app/ipd_print/print_history/<?php echo $getOPDPatient->IO_ID;?>/<?php echo $getOPDPatient->patient_no;?>" class="btn btn-default" target="_blank"><i class="fa fa-print"></i> Print</a>
                                           <a href="<?php echo base_url()?>app/ipd_print/pdf_history/<?php echo $getOPDPatient->IO_ID;?>/<?php echo $getOPDPatient->patient_no;?>" class="btn btn-success" target="_blank"><i class="fa fa-print"></i> PDF</a>
                                           ...
                                           <tbody>
                                           <?php foreach($patientHistory as $rows){?>
                                           <tr>
                                           		<td><?php echo date("M d, Y h:i:s A",strtotime($rows->dDateTime));?></td>
                                                <td><?php echo $rows->allergies?></td>
                                                <td><?php echo $rows->warnings?></td>
                                                <td><?php echo $rows->social_history?></td>
                                                <td><?php echo $rows->family_history?></td>
                                                <td><?php echo $rows->personal_history?></td>
                                                <td><?php echo $rows->past_medical_history?></td>
                                                <td><?php 
												$ci_obj = & get_instance();
                                                ...
                                                <?php if($this->session->userdata('emr_viewing') == ""){?>	
                                                <?php if($getOPDPatient->nStatus == "Pending"){?>
                                                <a href="<?php echo base_url()?>app/ipd/delete_history/<?php echo $rows->history_id?>/<?php echo $getOPDPatient->IO_ID?>/<?php echo $getOPDPatient->patient_no?>" onClick="return confirm('Are you sure you want to remove?');">Remove</a>
                                                <?php }}?>
                                                </td>
                                           </tr>
                                           <?php }?> 
        ...
        <!-- END BDAY -->
							...
							<!-- Modal -->
                            <form method="post" action="<?php echo base_url()?>app/ipd/save_history" onSubmit="return confirm('Are you sure you want to save?');">
                            ...
                            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <tr>
                                        	<td>Allergies</td>
                                            <td><textarea name="allergies" placeholder="Allergies" class="form-control input-sm" style="width: 100%;" rows="3"></textarea></td>
                                        </tr>
                                        <tr>
                                        	<td>Warnings</td>
                                            <td><textarea name="warnings" placeholder="Warnings" class="form-control input-sm" style="width: 100%;" rows="3"></textarea></td>
                                        </tr>
                                        <tr>
                                        	<td>Social History</td>
                                            <td><textarea name="social_history" placeholder="Social History" class="form-control input-sm" style="width: 100%;" rows="3"></textarea></td>
                                        </tr>
                                        <tr>
                                        	<td>Family History</td>
                                            <td><textarea name="family_history" placeholder="Family History" class="form-control input-sm" style="width: 100%;" rows="3"></textarea></td>
                                        </tr>
                                        <tr>
                                        	<td>Personal History</td>
                                            <td><textarea name="personal_history" placeholder="Personal History" class="form-control input-sm" style="width: 100%;" rows="3"></textarea></td>
                                        </tr>
                                        <tr>
                                        	<td>Past Medical History</td>
                                            <td><textarea name="past_medical_history" placeholder="Past Medical History" class="form-control input-sm" style="width: 100%;" rows="3"></textarea></td>
                                        </tr>
                                        </tbody>
                                        </table>
                                        </div>
